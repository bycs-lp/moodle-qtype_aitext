...
$string['async_grading_processing'] = 'Processing AI feedback...';
$string['async_grading_requesting'] = 'Requesting AI feedback...';
$string['async_grading_started'] = 'AI grading has started...';
$string['async_grading_waiting'] = 'Waiting for the AI grading task to start...';
$string['async_spellcheck_running'] = 'Running spellcheck...';
$string['attachmentsoptional'] = 'Attachments are optional';
$string['autograde'] = 'Automatic AI feedback';
$string['autograde_help'] = 'When enabled (default), AI feedback is automatically generated when the student submits the quiz attempt. When disabled, no AI feedback is triggered on submission. A teacher must then manually trigger the AI feedback from the grading interface.';
$string['autograde_pending_teacher'] = '<em>AI feedback has not been generated automatically. A teacher must trigger it manually.</em>';
...
$string['regrade_ai'] = 'Regrade with AI';
$string['regrade_ai_confirm'] = 'Are you sure you want to trigger AI regrading for the selected attempt(s)? This will generate new AI feedback using your AI model and quota.';
$string['regrade_ai_nothingselected'] = 'No attempts selected for AI regrading.';
$string['regrade_ai_success'] = 'AI regrading has been queued for {$a} attempt(s).';
$string['regrade_ai_triggered'] = 'AI regrading has been queued for this attempt.';
