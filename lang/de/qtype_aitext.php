...
$string['async_grading_complete'] = 'KI-Bewertung ist abgeschlossen.';
$string['async_grading_failed'] = 'KI-Bewertung fehlgeschlagen. Eine Lehrkraft muss diese Antwort manuell bewerten.';
$string['async_grading_placeholder'] = '<em>KI-Feedback wird gerade erzeugt. Bitte schauen Sie in Kürze wieder nach.</em>';
$string['async_grading_processing'] = 'KI-Feedback wird verarbeitet...';
$string['async_grading_requesting'] = 'KI-Feedback wird angefordert...';
$string['async_grading_started'] = 'KI-Bewertung gestartet...';
$string['async_grading_waiting'] = 'Warten auf den Start der KI-Bewertung...';
$string['async_spellcheck_running'] = 'Rechtschreibprüfung wird durchgeführt...';
$string['attachmentsoptional'] = 'Anhänge sind optional';
$string['autograde'] = 'Automatisches KI-Feedback';
$string['autograde_help'] = 'Wenn aktiviert (Standard), wird KI-Feedback automatisch generiert, wenn der Schüler den Testversuch abgibt. Wenn deaktiviert, wird beim Abgeben kein KI-Feedback ausgelöst. Die Lehrkraft muss das KI-Feedback dann manuell aus der Bewertungsoberfläche heraus auslösen.';
$string['autograde_pending_teacher'] = '<em>KI-Feedback wurde nicht automatisch generiert. Eine Lehrkraft muss es manuell auslösen.</em>';
...
$string['regrade_ai'] = 'Mit KI neu bewerten';
$string['regrade_ai_confirm'] = 'Sind Sie sicher, dass Sie die KI-Neubewertung für die ausgewählten Versuche auslösen möchten? Es wird neues KI-Feedback mit Ihrem KI-Modell und Ihrem Kontingent generiert.';
$string['regrade_ai_nothingselected'] = 'Keine Versuche für KI-Neubewertung ausgewählt.';
$string['regrade_ai_success'] = 'KI-Neubewertung wurde für {$a} Versuch(e) in die Warteschlange gestellt.';
$string['regrade_ai_triggered'] = 'KI-Neubewertung wurde für diesen Versuch in die Warteschlange gestellt.';
